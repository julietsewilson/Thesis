...
North_sea_data <- read.csv("North Sea isoscape data hake.csv", header = TRUE)
...
cairo_ps("Hake_NorthSea_Carbon_semivariance_viridis.eps", height = 10, width = 15)
...
jpeg("Carbon_isoscape_viridis_hake.jpeg")
...
jpeg("Carbon_variance_viridis_hake.jpeg")
...
writeRaster(carbon_raster, "Carbon_isoscape_NorthSea_hake", overwrite=TRUE)
writeRaster(carbon_raster_var, "Carbon_variance_NorthSea_hake", overwrite=TRUE)
...
cairo_ps("Hake_NorthSea_Nitrogen_semivariance_viridis.eps", height = 10, width = 15)
...
jpeg("Nitrogen_isoscape_viridis_hake.jpeg")
...
jpeg("Nitrogen_variance_viridis_hake.jpeg")
...
writeRaster(nitrogen_raster, "Nitrogen_isoscape_NorthSea_hake", overwrite=TRUE)
writeRaster(nitrogen_raster_var, "Nitrogen_variance_NorthSea_hake", overwrite=TRUE)
...
cairo_ps("Hake_NorthSea_Sulfur_semivariance_viridis.eps", height = 10, width = 15)
...
jpeg("Sulfur_isoscape_viridis_hake.jpeg")
...
jpeg("Sulfur_variance_viridis_hake.jpeg")
...
writeRaster(sulfur_raster, "Sulfur_isoscape_NorthSea_hake", overwrite=TRUE)
writeRaster(sulfur_raster_var, "Sulfur_variance_NorthSea_hake", overwrite=TRUE)

#### To plot isoscapes and variances in one figure

## Carbon isoscape and variance in one figure

jpeg("Carbon_isoscape&variance_viridis_hake.jpeg", height=15, width=25, units=c("cm"), res=600)
...
jpeg("Nitrogen_isoscape&variance_viridis_hake.jpeg", height=15, width=25, units=c("cm"), res=600)
...
jpeg("Sulfur_isoscape&variance_viridis_hake.jpeg", height=15, width=25, units=c("cm"), res=600)
...
jpeg("All_isoscape&variance_viridis_hake.jpeg", height=25, width=17, units=c("cm"), res=600)
