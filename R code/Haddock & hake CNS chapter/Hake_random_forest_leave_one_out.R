...
#Take out Cornwall and fisheries practical data
...
Assignments$True_location <- factor(Assignments$True_location, levels = c("North", "West Scotland", "Celtic", "Bay of Biscay", "Mediterranean"))

# For merged locations - Reorder Assigned locations to be from north to south
Assignments$Assigned_location <- factor(Assignments$Assigned_location, levels = c("North", "West Scotland", "Celtic", "Bay of Biscay", "Mediterranean"))
...
write.csv(Results_all, file = "SIA_hake_random_forest_leaveoneout_v1.csv")
