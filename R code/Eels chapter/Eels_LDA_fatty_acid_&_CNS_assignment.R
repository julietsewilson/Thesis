...
DA_data <- dplyr::select(data, -CN, -d13C)
...
write.csv(Assignment_means, file = "LDA_Assignment_means_eels_FA&SIA_repeat1000_July22.csv")

#Create excel spreadsheet for all repeats of probabilities
write.csv(Severn_assignments, file = "LDA_Results_Severn_eels_assignments_FA&SIA_1000_July22.csv")
write.csv(Parrett_assignments, file = "LDA_Results_Parrett_eels_assignments_FA&SIA_1000_July22.csv")
write.csv(Vilaine_assignments, file = "LDA_Results_Vilaine_eels_assignments_FA&SIA_1000_July22.csv")
write.csv(Oria_assignments, file = "LDA_Results_Oria_eels_assignments_FA&SIA_1000_July22.csv")
